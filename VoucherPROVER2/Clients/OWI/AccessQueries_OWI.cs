...
using static VoucherPROVER2.Clients.OWI.AccessToDatabase_OWI;
using System.Windows.Forms;

namespace VoucherPROVER2.Clients.OWI
{
    public class AccessQueries_OWI
    {

        public List<CheckTableGrid> GetCheckDataOWI(string refNumber)
        {
        ...
        public List<BillTable> GetBillData_OWI_DirectBill(string billRefNumber)
        {
            QBSessionManager sessionManager = new QBSessionManager();
        ...
        public List<BillTable> GetBillData_OWI(string refNumber)
        {
            QBSessionManager sessionManager = new QBSessionManager();
            List<BillTable> bills = new List<BillTable>();
        ...
        public List<CheckTableExpensesAndItems> GetCheckExpensesAndItemsData_OWI(string refNumber)
        {
            QBSessionManager sessionManager = new QBSessionManager();
            List<CheckTableExpensesAndItems> checks = new List<CheckTableExpensesAndItems>();
