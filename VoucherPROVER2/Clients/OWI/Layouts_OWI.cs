...
namespace VoucherPROVER2.Clients.OWI
{
    public class Layouts_OWI
    {
        ...
        public void PrintPage_OWI(object sender, PrintPageEventArgs e, int layoutIndex, string seriesNumber, object data, string payeeOverride = "")
        {
