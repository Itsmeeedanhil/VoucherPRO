...
namespace VoucherPROVER2.Clients.DRC
{
    public class Layouts_DRC
    {
        ...
        public void PrintPage_DRC(object sender, PrintPageEventArgs e, int layoutIndex, string seriesNumber, object data, string payeeOverride = "")
        {
